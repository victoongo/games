...
class Ship:
    ...
    def shoot(self):
        ...
        rock_group.add(Sprite(missile_pos, missile_vel, self.angle, 0, missile_image, missile_info, missile_sound))
...
class Sprite:
    ...
    def collide(self, other_object):
        dist = math.sqrt((self.pos[0] - other_object.get_position()[0]) ** 2 + (self.pos[1] - other_object.get_position()[1]) ** 2)
